...
export function Footer() {
  ...
  return (
    <footer id="contact" className="bg-gray-50 mt-24 text-title ">
        <div className="container pt-6 pb-6">
            <div className="sm:flex md:items-center sm:justify-between text-black sm:flex-row ">
                ...
                <div className="flex justify-between gap-x-12 sm:gap-x-16 md:gap-x-20 lg:gap-x-48 mt-5 sm:mt-0">
                    <div className="">
                        <li className="list-none">
                            <a className="hover:text-red-600" href="/pagina-de-exemplo">Home</a>
                        </li>
                        <li className="list-none py-2">
                            <a className="hover:text-red-600" href="/pagina-de-exemplo">Quem Somos</a>
                        </li>
                        <li className="list-none">
                            <a className="hover:text-red-600" href="/pagina-de-exemplo">Serviços</a>
                        </li>
                    </div>
                    <div>
                        <li className="list-none ">
                            <a className="hover:text-red-600" href="/pagina-de-exemplo">Área de Atuação</a>
                        </li>
                        <li className="list-none py-2">
                            <a className="hover:text-red-600" href="/pagina-de-exemplo">Área Restrita</a>
                        </li>
                        <li className="list-none">
                            <a className="hover:text-red-600" href="/pagina-de-exemplo">Contato</a>
                        </li>
                    </div>
                </div>
                <div className="flex text-center flex-col mt-6 sm:mt-0">
                    <li className="list-none ">
                        <a className="hover:text-red-600" href="/pagina-de-exemplo">Entre em contato</a>
                    </li>
                    <li className="list-none py-2">
                        <a className="hover:text-red-600" href="/pagina-de-exemplo">(17)99999-9999</a>
                    </li>
                    <li className="list-none">
                        <a className="hover:text-red-600" href="/pagina-de-exemplo">testeteste@teste.com</a>
                    </li>
        ...
        <div className="bg-gray-100 text-black flex justify-center py-3 sm:flex-row flex-col items-center">
            <p>&copy;mCMS MBDX Tecnologia 2023 © Todos direitos reservados</p>
            <div className=" gap-x-2 flex ml-6">
